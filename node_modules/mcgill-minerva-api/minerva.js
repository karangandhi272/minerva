      ...
      function buildAddDropForm(currentCourses, sel, isDrop) {
        ...
        if (currentCourses && currentCourses.length > 0) {
          currentCourses.forEach(function(course) {
            if (course.crn) {
              ...
              formParts.push("start_date_in=" + encodeURIComponent(course.start_date || "08/27/" + (selection.year || '2025')));
              formParts.push("end_date_in=" + encodeURIComponent(course.end_date || "12/03/" + (selection.year || '2025')));
        ...
        if (!isDrop) {
          crnArray.forEach(function(crn) {
            ...
            formParts.push("start_date_in=08/27/" + (selection.year || '2025'));
            formParts.push("end_date_in=12/03/" + (selection.year || '2025'));
            formParts.push("SUBJ=");
            formParts.push("CRSE=");
            formParts.push("SEC=");
            formParts.push("LEVL=Undergraduate");
            formParts.push("CRED=3.000");
            formParts.push("GMOD=Standard");
        ...
        // Add empty slots for additional courses (exactly matching the reference format)
        for (var i = 0; i < 10; i++) {
          formParts.push("RSTS_IN=RW");
