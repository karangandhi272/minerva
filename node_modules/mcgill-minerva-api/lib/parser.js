  ...
  parseWeeklySchedule: function(html) {
    ...
    try {
      ...
      $('a[href*="P_CrseSchdDetl"]').each(function() {
        ...
        // Looking at the log: "COMP 302-0012425 2 times 1.5 hrs/wk8:35 am-9:55 amStewart Biology Building S1/4"
        // The section appears to be including extra digits, let's fix this
        ...
        if (courseCodeMatch) {
          ...
          function convertTime(timeStr) {
            ...
            return timeStr.replace(/(\d{1,2}):(\d{2})\s*(am|pm)/gi, function(match, hour, min, ampm) {
              ...
              // Fix padStart compatibility issue
          ...
          try {
            ...
            console.log('Error getting cell index:', indexError);
            // Fallback: try to determine day from the course itself or default to empty
            cellIndex = -1;
          }
          ...
          var day = '';
          if (cellIndex >= 0 && cellIndex < dayMap.length) {
            day = dayMap[cellIndex];
          }
