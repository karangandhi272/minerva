  ...
  parseWeeklySchedule: function(html) {
    ...
    try {
      ...
      dayHeaders.forEach(function(header, index) {
        ...
        if (cleanHeader.includes('monday')) dayMap[index] = 'Monday';
        else if (cleanHeader.includes('tuesday')) dayMap[index] = 'Tuesday';
        else if (cleanHeader.includes('wednesday')) dayMap[index] = 'Wednesday';
        else if (cleanHeader.includes('thursday')) dayMap[index] = 'Thursday';
        else if (cleanHeader.includes('friday')) dayMap[index] = 'Friday';
        else if (cleanHeader.includes('saturday')) dayMap[index] = 'Saturday';
        else if (cleanHeader.includes('sunday')) dayMap[index] = 'Sunday';
      });
      ...
      scheduleTable.find('tr').each(function(rowIndex) {
        ...
        row.find('td').each(function(cellIndex) {
          ...
          if (courseLinks.length > 0) {
            ...
            console.log('Found', courseLinks.length, 'course links in cell', cellIndex, 'day:', day);
            ...
            courseLinks.each(function() {
              ...
              // Example: "MGCR 341-001\n3391 -\n8:35 am-9:55 am\nBronfman Building 151"
              ...
              if (lines.length >= 3) {
                ...
                if (courseCodeMatch) {
                  ...
                  // Extract time from the third line (e.g., "8:35 am-9:55 am")
                  var timeInfo = '';
