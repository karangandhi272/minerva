...
module.exports = {
  ...
  parseWeeklySchedule: function(html) {
    ...
    try {
      ...
      // Map header indices to day names
      var dayMap = {};
      dayHeaders.forEach(function(header, index) {
        var cleanHeader = header.toLowerCase().trim();
        if (cleanHeader.includes('monday') || cleanHeader.includes('mon')) dayMap[index] = 'Monday';
        else if (cleanHeader.includes('tuesday') || cleanHeader.includes('tue')) dayMap[index] = 'Tuesday';
        else if (cleanHeader.includes('wednesday') || cleanHeader.includes('wed')) dayMap[index] = 'Wednesday';
        else if (cleanHeader.includes('thursday') || cleanHeader.includes('thu')) dayMap[index] = 'Thursday';
        else if (cleanHeader.includes('friday') || cleanHeader.includes('fri')) dayMap[index] = 'Friday';
        else if (cleanHeader.includes('saturday') || cleanHeader.includes('sat')) dayMap[index] = 'Saturday';
        else if (cleanHeader.includes('sunday') || cleanHeader.includes('sun')) dayMap[index] = 'Sunday';
      });
      ...
      targetTable.find('tr').each(function(rowIndex) {
        ...
        row.find('td').each(function(cellIndex) {
          ...
          if (courseLinkInCell.length > 0) {
            ...
            console.log('Found', courseLinkInCell.length, 'course links in cell', cellIndex, 'day:', day);
